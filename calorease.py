...
def p_sum_day(t):
    ...
    if fecha in intakes:
        ...
        for calorias in daily_intake.values():
            cal_total += calorias
        print(f"Calorias totales del día {fecha}: {round(cal_total, 3)} kcal")
    else:
...
def p_expr_food_with(t):
    ...
    print(f"A continuación se muestra un ejemplo de un plato que tiene un total de {cal_disp} kcal")
...
while True:
    try:
        ...
        break
    parser.parse(data)
>>>>>>> 74851124f764ddf02c6b1772d530f03570588cca
